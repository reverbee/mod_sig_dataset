function [] = fmb_freq_scan_esmb
% freq scan using esmb to get fmb signal
%
% [usage]
% fmb_freq_scan_esmb
%
...
fprintf(esmb, 'FREQ:STAR 88.1 MHz;STOP 108.1 MHz');
