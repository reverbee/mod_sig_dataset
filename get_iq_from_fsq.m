function [iq, sample_rate_mhz] = ...
    get_iq_from_fsq(center_freq_mhz, signal_bw_mhz, sample_length, sample_per_symbol, directory, plot_signal)
...
% [usage]
% (fm broadcasting)
% get_iq_from_fsq(98.5, .192, 2^21, 0, 'e:\fsq_iq\data', 0);
% get_iq_from_fsq(98.5, .2, 8192, 0, '', 1);
% get_iq_from_fsq(98.5, .2, 8192, 0, 'e:\fsq_iq\data', 1);
% (digital terrestrial tv)
% get_iq_from_fsq(491, 10, 8192, 8, '', 1);
%
% ##### not tested!!(180131)
% (dmb)
% get_iq_from_fsq(199.28, 2, 8192 * 2, 1, '', 1);
% (884.58 mhz cdma basestation)
% get_iq_from_fsq(884.58, 2, 8192, 1, '', 1);
% get_iq_from_fsq(884.58, 2, 16776704/32, '', 1);
% get_iq_from_fsq(884.58, 2, 16776704/32, '', 1);
% get_iq_from_fsq(884.58, 2, 16776704/32, '', 1);
% get_iq_from_fsq(884.58, 2, 16776704/32, 'e:\fsq_iq\data', 1);
% 
