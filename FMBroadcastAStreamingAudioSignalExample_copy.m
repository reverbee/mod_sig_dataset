...
% Modulate and demodulate a streaming audio signal with the FM broadcast modulator 
% and demodulator objects. Play the audio signal using a default audio device.
% 
% *Note*: This example runs only in R2016b or later. If you are using an 
% earlier release, replace each call to the function with the equivalent  |step| 
...
%% 
% Create FM broadcast modulator and demodulator objects. Set the |AudioSampleRate| 
% property to match the sample rate of the input signal. Set the |SampleRate| 
% property of the demodulator to match the specified sample rate of the modulator. 
