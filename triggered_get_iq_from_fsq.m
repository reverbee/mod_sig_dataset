function [iq, sample_rate_mhz] = ...
    triggered_get_iq_from_fsq(center_freq_mhz, signal_bw_mhz, sample_length, sample_per_symbol, directory, ...
    plot_signal, input_atten_db)
% triggered get iq from R&S FSQ26 signal analyzer
% based on "get_iq_from_fsq_181107.m"
%
...
% [usage]
% (fm broadcasting)
% triggered_get_iq_from_fsq(95.7, .192, 2^17, 0, 'e:\fsq_iq\data', 0, 0);
% triggered_get_iq_from_fsq(95.7, .192, 2^21, 0, 'e:\fsq_iq\data', 0, '');
% 
