...
%
% [usage]
% fm_radio_modulation(8192, 75e3, 10, 1, 0, 'gsmRAx6c1', 400e3, 0, 0, 100, 180);
% fm_radio_modulation(8192, 75e3, '', 1, 0, '', 400e3, 0, 0, 100, 180);
% fm_radio_modulation(2^18, 75e3, 10, 1, 1, 'gsmRAx4c2', 400e3, 0, 1, 100, 180);
% fm_radio_modulation(2^18, 75e3, '', 1, 1, '', 400e3, 0, 1, 100, 180);
% 
