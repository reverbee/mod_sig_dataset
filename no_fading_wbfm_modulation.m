function [] = no_fading_wbfm_modulation(source_sample_length, freq_dev, snr_db, plot_modulated_signal, sound_demod)
...
%
% [usage]
% no_fading_wbfm_modulation(8192, 30e3, 10, 1, 0)
% no_fading_wbfm_modulation(8192, 30e3, '', 1, 0)
% no_fading_wbfm_modulation(2^18, 30e3, 10, 1, 1)
% no_fading_wbfm_modulation(2^18, 30e3, '', 1, 1)
% 
