...
%
% [usage]
% wbfm_modulation(8192, 30e3, 10, 1, 0, 'gsmRAx6c1', 220.5e3, 0, 0, 100, 180);
% wbfm_modulation(8192, 30e3, '', 1, 0, '', 220.5e3, 0, 0, 100, 180);
% wbfm_modulation(2^18, 30e3, 10, 1, 1, 'gsmRAx4c2', 220.5e3, 0, 1, 100, 180);
% wbfm_modulation(2^18, 30e3, '', 1, 1, '', 220.5e3, 0, 1, 100, 180);
% 
