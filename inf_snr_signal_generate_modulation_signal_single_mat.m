function [] = ...
    inf_snr_signal_generate_modulation_signal_single_mat(signal_dir_name, instance_length, ...
...
%
% [usage]
% generate_modulation_signal_single_mat('e:\temp\mod_signal', 20, '', 8)
% generate_modulation_signal_single_mat('e:\temp\mod_signal', 1000, '', 8)
% generate_modulation_signal_single_mat('e:\temp\mod_signal', 1000, '_10sps', 10)
    ...
    for m = 1 : mod_length
        ...
        switch modulation_name
            ...
            case 'nbfm'
                ...
                % ##################################################
                inf_snr_iq = nbfm.y;
                iq = inf_snr_signal_gen_fm_mod_iq(inf_snr_iq, instance_length, iq_sample_length, snr_db, ...
