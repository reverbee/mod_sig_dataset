function [] = inf_snr_generate_feature_of_modulation_signal(signal_dir_name, instance_length, mat_filename_append_string, ...
    sample_per_symbol)
...
%
% [usage]
% inf_snr_generate_feature_of_modulation_signal('e:\temp\mod_signal', 1000, '_inf_snr', 8)
%
% [run time]
% when 1000 instance, 9 modulation, 16 snr, 1024 iq sample, 18 feature, 
% program run time = 168 min 
...
fprintf('#### inf snr fm signal loaded from mat file\n');
