function inf_snr_generate_simple_radio_signal(fs, talk_duration_vec, save_signal)
% generate simple radio signal with infinte snr
%
% modified from "generate_simple_radio_signal.m"
% #######################
...
%
% [input]
% - fs: sample rate in hz. must be one of 11025, 14700 because "decimate" function is used
...
% - talk_duration_vec: talk duration vector
%   when length(talk_duration_vec) = 2, simple radio signal = dtmf_1 + talk_1 + dtmf_2 + talk_2
% - save_signal: boolean
% 
% [usage]
% inf_snr_generate_simple_radio_signal(14700, [7,5,6,4], 0)
% inf_snr_generate_simple_radio_signal(11025, [7,5,6,4], 1)
%
...
if save_signal
    signal_filename = sprintf('inf_snr_simpe_radio_fd%d_fs%d.mat', ...
        freq_dev, fs);
